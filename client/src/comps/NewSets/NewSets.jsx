        ...
        <section className="Home-New-Sets">
            <section className="Home-New-Sets-Top">
                <div className="Home-New-Sets-Top-Heading">
                    <div className="Home-New-Sets-Top-Heading-Left">
                        ...
                        <button className="Home-New-Sets-Top-Heading-Right-Button">
                            View All
                        </button>
                    </div>
                </div>
            ...
            <section className="Home-New-Sets-Bottom-PokeSet">
                <div className="Home-New-Sets-Bottom-PokeSet-Con">
                    ...
                    <a class="Home-New-Sets-Bottom-PokeSet-Con-Link" href="/sets/SWSH8-Fusion-Strike" title="Fusion Strike Set">
                    ...
                    <a class="Home-New-Sets-Bottom-PokeSet-Con-Link" href="/sets/25TH-Celebrations" title="Celebrations Set">
                    ...
                    <a class="Home-New-Sets-Bottom-PokeSet-Con-Link" href="/sets/SWSH7-Evolving-Skies" title="Evolving Skies Set">
                    ...
                    <a class="Home-New-Sets-Bottom-PokeSet-Con-Link" href="/sets/CRE-Chilling-Reign" title="Chilling Reign Set">
                    ...
                    <a class="Home-New-Sets-Bottom-PokeSet-Con-Link" href="/sets/SWSH05-Battle-Styles" title="Battle Styles Set">
                    ...
                    <a class="Home-New-Sets-Bottom-PokeSet-Con-Link" href="/sets/SWSH45-Shining-Fates" title="Shining Fates Set">
